...
public class BundleClassManagerTest {
	...
	@Test
	public void testSimpleResourceRetrieval() {
		try {
			BundleClassManager testee = new BundleClassManager(ClassLoader.getSystemClassLoader());
			LibraryClassLoader lib1 = new LibraryClassLoader(
					LoadedLibraryCache.createFromJar("export/jars/i5.las2peer.classLoaders.testPackage1-1.1.jar"),
					testee);
			LibraryClassLoader lib2 = new LibraryClassLoader(
					LoadedLibraryCache.createFromJar("export/jars/i5.las2peer.classLoaders.testPackage2-1.0.jar"),
					testee);
	...
	public void testSimpleClassLoading1() {
		try {
			BundleClassManager testee = new BundleClassManager(ClassLoader.getSystemClassLoader());
			LibraryClassLoader lib1 = new LibraryClassLoader(
					LoadedLibraryCache.createFromJar("export/jars/i5.las2peer.classLoaders.testPackage1-1.0.jar"),
					testee);
			LibraryClassLoader lib2 = new LibraryClassLoader(
					LoadedLibraryCache.createFromJar("export/jars/i5.las2peer.classLoaders.testPackage2-1.0.jar"),
					testee);
	...
	@Test
	public void testSeperateCounters() {
		try {
			LoadedLibraryCache cache10 = LoadedLibraryCache
					.createFromJar("export/jars/i5.las2peer.classLoaders.testPackage1-1.0.jar");
			LoadedLibraryCache cache11 = LoadedLibraryCache
