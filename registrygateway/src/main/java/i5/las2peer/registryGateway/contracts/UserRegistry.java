...
public class UserRegistry extends Contract {
    ...
    public Observable<UserRegisteredEventResponse> userRegisteredEventObservable(EthFilter filter) {
    ...
    public Observable<UserRegisteredEventResponse> userRegisteredEventObservable(DefaultBlockParameter startBlock, DefaultBlockParameter endBlock) {
        ...
        return userRegisteredEventObservable(filter);
    }
    ...
    public Observable<UserTransferredEventResponse> userTransferredEventObservable(EthFilter filter) {
        return web3j.ethLogObservable(filter).map(new Func1<Log, UserTransferredEventResponse>() {
            @Override
            public UserTransferredEventResponse call(Log log) {
    ...
    public Observable<UserTransferredEventResponse> userTransferredEventObservable(DefaultBlockParameter startBlock, DefaultBlockParameter endBlock) {
        EthFilter filter = new EthFilter(startBlock, endBlock, getContractAddress());
        filter.addSingleTopic(EventEncoder.encode(USERTRANSFERRED_EVENT));
        return userTransferredEventObservable(filter);
    }
