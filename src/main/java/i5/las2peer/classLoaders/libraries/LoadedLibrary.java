...
public abstract class LoadedLibrary {
	...
	/**
	 * generates a new CL without any dependencies
	 * i.e. this ClassLoader may not use any other registered libraries
	 * 
	...
	/**
	 * 
	 * @return the identifier (name and version) for the library to which this 
	 * 			ClassLoader is bound
	 */
	...
	/**
	 * returns the library identifier for the library, this object is responsible for
	...
	/**
	 * Helper method to get the name of a class file from the corresponding name
	 * of the class
	 *
