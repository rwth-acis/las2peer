...
public class PackageTestService extends Service {
	...
	/**
	 * unpack the given instance of the class SomeValue placed in the helper library and return the doubled 
	 * value
	 * 
	 * @param aValue
	...
	public String getResContent () throws IOException {
		return FileContentReader.read( getClass().getClassLoader().getResourceAsStream("i5/las2peer/testing/services/test.xml" ) );
	}
