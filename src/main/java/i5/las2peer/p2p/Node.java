...
public abstract class Node extends Configurable implements AgentStorage, NodeStorageInterface {
	 ...
	 */
	private Hashtable<Long, AgentContext> htLocalExecutionContexts = new Hashtable<>();
	 ...
	 */
	private Hashtable<Long, MessageReceiver> htRegisteredReceivers = new Hashtable<>();

	/**
	 * map with all topics and their listeners
	 */
	private HashMap<Long, TreeMap<Long, MessageReceiver>> mapTopicListeners = new HashMap<>();
	/**
	 * other direction of {@link #mapTopicListeners}
	 */
	private HashMap<Long, TreeSet<Long>> mapListenerTopics = new HashMap<>();
