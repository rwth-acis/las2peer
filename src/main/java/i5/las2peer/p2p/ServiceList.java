...
public class ServiceList implements Serializable {
	...
	public void addService(ServiceNameVersion serviceNameVersion) {
		...
		if (!versions.containsKey(serviceNameVersion.getVersion().toString())) {
			versions.put(serviceNameVersion.getVersion().toString(), serviceNameVersion);
		}
	}
	...
	public void removeService(ServiceNameVersion serviceNameVersion) {
		...
		if (versions != null) {
			if (versions.containsKey(serviceNameVersion.getVersion().toString())) {
				versions.remove(serviceNameVersion.getVersion().toString());
			}
