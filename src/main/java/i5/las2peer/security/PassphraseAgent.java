...
public abstract class PassphraseAgent extends Agent {
	/**
	 * random salt for the encryption of the private key
	 * (necessary for generating a strong key from a given passphrase)
	 */
	private byte[] salt; 
	 ...
	 */	
	protected PassphraseAgent ( long id, KeyPair pair, String passphrase, byte[] salt ) throws L2pSecurityException, CryptoException{
	...
	/**
	 * provide access to salt for subclasses
	 ...
	 * The key has to be unlocked first, of course.
	 * 
	 * @param passphrase
	 * @throws L2pSecurityException
	 */
