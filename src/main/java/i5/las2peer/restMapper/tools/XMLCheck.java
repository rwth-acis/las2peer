...
//            dBuilder=dbFactory.newDocumentBuilder();
			...
			// schema = factory.newSchema(new StreamSource(new StringReader(RESTMapper.getFile(new
			// File("./xsd/validation/restschema.xsd")))));
			try {
				...
				try {
					schema = factory.newSchema(
							new StreamSource(new StringReader(RESTMapper.getFile(new File("./xsd" + XSD_FILE)))));
