 ...
 * 	\033[xxx;xxx;xxxm
 * the methods sendCode may be used for that.
 * 
...
public class ColoredOutput {
	 ...
	 * write blining text
	 */
	public static void blink () {sendCode ( 5);	}
	
	/**
	 * turn off blinking text
	 */
	public static void noBlink () {sendCode ( 25);	}
	
	/**
	 * write bold text
	 */
	public static void bold () { sendCode ( 1); }

	/**
	 * turn off bold text
	 */
	public static void noBold() { sendCode ( 22); }
	
	/**
	 * write underlined text
	 */
	public static void underline () { sendCode ( 4);  }
	
	/**
	 * write inverted (swap back- and foreground color
	 */
	public static void inverted () { sendCode ( 7); }
	
	/**
	 * switch to black font color
	 */
	public static void fontBlack () { sendCode( Color.Black); }

	/**
	 * switch to red font color
	 */
	public static void fontRed () { sendCode( Color.Red); }

	/**
	 * switch to green font color
	 */
	public static void fontGreen () { sendCode(Color.Green); }

	/**
	 * switch to brown font color
	 */
	public static void fontBrown () { sendCode( Color.Brown); }

	
	/**
	 * switch to blue font color
	 */
	public static void fontBlue () { sendCode( Color.Blue); }

	/**
	 * switch to magenta font color
	 */
	public static void fontMagenta () { sendCode( Color.Magenta); }

	/**
	 * switch to cyan font color
	 */
	public static void fontCyan () { sendCode( Color.Cyan); }

	/**
	 * switch to light grey font color
	 */
	public static void fontLightGrey () { sendCode( Color.LightGrey); }

	/**
	 * switch to dark grey font color
	 */
	public static void fontDarkGrey () { sendCode( Color.DarkGrey); }

	/**
	 * switch to light red font color
	 */
	public static void fontLightRed () { sendCode( Color.LightRed); }

	/**
	 * switch to light green font color
	 */
	public static void fontLightGreen () { sendCode( Color.LightGreen); }

	/**
	 * switch to yellow font color
	 */
	public static void fontYellow () { sendCode( Color.Yellow); }

	/**
	 * switch to light blue font color
	 */
	public static void fontLightBlue () { sendCode( Color.LightBlue); }

	/**
	 * switch to light magenta font color
	 */
	public static void fontLightMagenta () { sendCode( Color.LightMagenta); }

	/**
	 * switch to lighty cyan font color
	 */
	public static void fontLightCyan () { sendCode( Color.LightCyan); }

	/**
	 * switch to white font color
	 */
	public static void fontWhite () { sendCode( 1, 37); }
	
	/**
	 * reset to terminal default
	 */
	public static void fontReset () { sendCode( 39); }

	/**
	 * switch background to black
	 */
	public static void backgroundBlack () { sendCode( 40); }

	/**
	 * switch background to red
	 */
	public static void backgroundRed () { sendCode( 41); }

	/**
	 * switch background to green
	 */
	public static void backgroundGreen () { sendCode( 42); }

	/**
	 * switch background to yellow
	 */
	public static void backgroundYellow () { sendCode( 43); }

	/**
	 * switch background to blue
	 */
	public static void backgroundBlue () { sendCode( 44); }

	/**
	 * switch background to magenta
	 */
	public static void backgroundMagenta () { sendCode( 45); }

	/**
	 * switch background to cyan
	 */
	public static void backgroundCyan () { sendCode( 46); }

	/**
	 * switch background to white
	 */
	public static void backgroundWhite () { sendCode( 47); }

	/**
	 * reset background to terminal default
	 */
	public static void resetBackground () { sendCode( 49); }
