...
public class LaunchDirGeneratorSize {
	...
	public static void main(String[] argv) throws IOException {
		int[][] combinations = new int[][] { new int[] { 20, 10, 0500 }, new int[] { 20, 10, 1000 },
				new int[] { 20, 10, 1500 }, new int[] { 20, 10, 2000 }, new int[] { 20, 10, 2500 },
				new int[] { 20, 10, 3000 }, new int[] { 20, 10, 3500 }, new int[] { 20, 10, 4000 },
				new int[] { 20, 10, 4500 }, new int[] { 20, 10, 5000 },

				new int[] { 40, 10, 2000 }, new int[] { 40, 20, 2000 }, new int[] { 40, 30, 2000 },
				new int[] { 40, 40, 2000 }, new int[] { 40, 50, 2000 }, new int[] { 40, 60, 2000 },
				new int[] { 40, 70, 2000 }, new int[] { 40, 80, 2000 }, new int[] { 40, 90, 2000 },
				new int[] { 40, 100, 2000 },

				new int[] { 10, 20, 1000 }, new int[] { 20, 20, 1000 }, new int[] { 30, 20, 1000 },
				new int[] { 40, 20, 1000 }, new int[] { 50, 20, 1000 }, new int[] { 60, 20, 1000 },
				new int[] { 70, 20, 1000 }, new int[] { 80, 20, 1000 }, new int[] { 90, 20, 1000 },
				new int[] { 100, 20, 1000 }, new int[] { 110, 20, 1000 }, new int[] { 120, 20, 1000 },
				new int[] { 130, 20, 1000 }, new int[] { 140, 20, 1000 }, new int[] { 150, 20, 1000 },
