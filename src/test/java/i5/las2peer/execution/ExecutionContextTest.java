...
public class ExecutionContextTest {
	...
	@Before
	public void setup() throws MalformedXMLException, IOException, AgentAccessDeniedException, AgentAlreadyRegisteredException, L2pSecurityException, AgentException, CryptoException {
		...
		ServiceAgentImpl serviceAgent = ServiceAgentImpl.createServiceAgent(ServiceNameVersion.fromString("i5.las2peer.api.TestService@0.1"), "pass");
	...
	public void testGetter() throws MalformedXMLException, IOException {
		...
		assertEquals(context.getServiceAgent().getServiceNameVersion(), ServiceNameVersion.fromString("i5.las2peer.api.TestService@0.1"));
