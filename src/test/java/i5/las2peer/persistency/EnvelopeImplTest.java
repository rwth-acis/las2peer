...
public class EnvelopeImplTest {
	...
	@Test
	public void testFresh() throws MalformedXMLException, IOException, IllegalArgumentException, SerializationException, CryptoException, L2pSecurityException, AgentException, EnvelopeException {
		...
		assertEquals(envelope.getSigningAgentId(), owner.getId());
