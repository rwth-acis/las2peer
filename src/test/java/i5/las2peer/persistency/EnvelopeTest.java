...
public class EnvelopeTest {
	...
	@Test
	public void testStringContent() throws NoSuchAlgorithmException, UnsupportedEncodingException, MalformedXMLException, XMLSyntaxException, L2pSecurityException, EnvelopeException {
		if ( eve == null ) throw new NullPointerException ( "Agents not initialized!");
	...
	@Test
	public void testSerializable () throws L2pSecurityException, EnvelopeException, MalformedXMLException, SerializationException {
		String s = "Hallo"; int i = 100;
	...
	@Test
	public void testAgentRemoval () throws UnsupportedEncodingException, EncodingFailedException, DecodingFailedException, L2pSecurityException {
	...
	@Test
	public void testOpen() throws EncodingFailedException, UnsupportedEncodingException, DecodingFailedException, MalformedXMLException, L2pSecurityException {
	...
	@Test 
	public void testSignatures () throws UnsupportedEncodingException, EncodingFailedException, DecodingFailedException, MalformedXMLException, VerificationFailedException, L2pSecurityException {
	...
	@Test
	public void testOpeningAgent () throws UnsupportedEncodingException, EncodingFailedException, DecodingFailedException, L2pSecurityException {
	...
	@Test
	public void testId () throws MalformedXMLException, UnsupportedEncodingException, EncodingFailedException, DecodingFailedException {
		String content = "bla";
		Envelope testee = new Envelope ( content, eve );
		String xml = testee.toXmlString();
	...
	@Test
	public void testGroups () throws MalformedXMLException, IOException, L2pSecurityException, SerializationException, CryptoException, EnvelopeException {
		
		Agent[] owners = new Agent[] {
				MockAgentFactory.getEve(),
	...
	@Test
	public void testArrayStorage () throws MalformedXMLException, IOException, EnvelopeException, SerializationException, L2pSecurityException {
	...
	@Test
	public void testCheckOverwrite () throws L2pSecurityException, EncodingFailedException, SerializationException, InterruptedException, DecodingFailedException, MalformedXMLException, IOException {
		UserAgent eve = MockAgentFactory.getEve();
	...
	@Test
	public void testLoadedTimestamp () throws EncodingFailedException, SerializationException, MalformedXMLException, IOException {
		UserAgent eve = MockAgentFactory.getEve();
	...
	@Test
	public void testUpdateSwitch () throws EnvelopeException, MalformedXMLException, IOException, SerializationException, L2pSecurityException {
		UserAgent eve = MockAgentFactory.getEve();
