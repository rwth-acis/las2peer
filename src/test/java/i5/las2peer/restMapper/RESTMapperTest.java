...
//            String s = tree.merge(tree5);
	...
	public void testA4() {
		try {
			invokeMethod("post", "hi/b/c", new Pair[] { new Pair<String>("d", "12"), new Pair<String>("e", "4") }, "",
					new Pair[] {}, "a4", "hi16");
		} catch (Exception e) {
			e.printStackTrace();
			fail(e.getMessage());
	...
	public void testHeaders1() {
		try {
			invokeMethod("delete", "users/12", new Pair[] {}, "", new Pair[] { new Pair<String>("productID", "12") },
					"Headers1", "1440.0");
		} catch (Throwable e) {
			e.printStackTrace();
			fail(e.getMessage());
	...
	public void testConsumes2() {
		try {
			invokeMethod("post", "animals/3", new Pair[] {}, "", MediaType.VIDEO_AVI, new Pair[] {}, "Consumes2", "33"); // test
		} catch (Throwable e) {
			e.printStackTrace();
			fail(e.getMessage());
		}
	...
	public void testProduces1() {
		try {
			invokeMethod("get", "books/4", new Pair[] {}, "", MediaType.VIDEO_AVI, "audio/*,audio/ogg", new Pair[] {},
					"Produces1", "8");
			invokeMethod("get", "books/4", new Pair[] {}, "", MediaType.VIDEO_AVI, "video/mp4,text/*", new Pair[] {},
					"Produces1", "4");
		} catch (Throwable e) {
			e.printStackTrace();
			fail(e.getMessage());
