...
public class TestClass2 {
	...
	@DELETE
	@Path("/users/{a}")
	public String b3(@PathParam("a") int userID,
			@HeaderParam(value = "productID") @DefaultValue(value = "0") short productID,
			@HeaderParam(value = "price") @DefaultValue(value = "0") float price)
	{
		return userID * productID + "" + price + "";
	}
