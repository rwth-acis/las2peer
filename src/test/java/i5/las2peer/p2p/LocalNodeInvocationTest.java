...
public class LocalNodeInvocationTest {
	...
	@Test
	public void testLocalInvocation() throws SecurityException, IllegalArgumentException, AgentNotKnownException,
	...
	public void testSubinvocation() throws MalformedXMLException, IOException, L2pSecurityException, CryptoException,
		...
		ServiceAgent testServiceAgent2 = ServiceAgent
				.createServiceAgent(ServiceNameVersion.fromString("i5.las2peer.api.TestService2@1.0"), "a 2nd pass");
	...
	public void testSubinvocationFail()
			throws MalformedXMLException, IOException, L2pSecurityException, CryptoException, InterruptedException,
			AgentAlreadyRegisteredException, AgentException, TimeoutException, NodeException {
		LocalNode serviceNode2 = LocalNode.newNode();
		UserAgent eve = MockAgentFactory.getEve();
