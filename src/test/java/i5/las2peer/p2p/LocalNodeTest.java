...
public class LocalNodeTest {
	...
	@Before
	public void setUp () throws NoSuchAlgorithmException, L2pSecurityException, CryptoException, MalformedXMLException, IOException {
		LocalNode.reset();
	...
	@Test
	public void test() throws AgentAlreadyRegisteredException, EncodingFailedException, L2pSecurityException, SerializationException, InterruptedException, AgentException, AgentNotKnownException {
	...
	@Test
	public void testTwoNodes () throws L2pSecurityException, EncodingFailedException, SerializationException, InterruptedException, AgentException {
		adam.unlockPrivateKey("adamspass");
		eve.unlockPrivateKey("evespass");
	...
	@Test
	public void testTimeout () throws EncodingFailedException, L2pSecurityException, SerializationException, InterruptedException, AgentException {
		adam.unlockPrivateKey("adamspass");
	...
	@Test 
	public void testBroadcast () throws EncodingFailedException, L2pSecurityException, SerializationException, InterruptedException, AgentException, AgentNotKnownException {
		adam.unlockPrivateKey("adamspass");
		eve.unlockPrivateKey("evespass");
	...
	@Test
	public void testRegisteringAgents() throws L2pSecurityException, MalformedXMLException, IOException, AgentAlreadyRegisteredException, AgentNotKnownException, AgentException {
		adam.unlockPrivateKey("adamspass");
	...
	public void testSimpleInvocation () throws L2pSecurityException, CryptoException, AgentAlreadyRegisteredException, AgentException, SecurityException, IllegalArgumentException, AgentNotKnownException, NoSuchMethodException, IllegalAccessException, InvocationTargetException, InterruptedException {
		...
		Serializable result = testee.invokeLocally(eve.getId(), serviceClass, "inc", new Serializable[] { new Integer ( 10 ) });
	...
	public void testUserRegistry () throws CryptoException, L2pSecurityException, AgentException {
		...
		a.unlockPrivateKey("a"); b.unlockPrivateKey("b");
		
		a.setLoginName( "alpha"); b.setLoginName("beta");
	...
	@Test
	public void testUserRegDistribution () throws L2pSecurityException, AgentException, CryptoException, ArtifactNotFoundException {
