...
public class MediatorTest {
	...
	@Test
	public void testMessages() throws L2pSecurityException, MessageException, AgentNotKnownException,
	...
	@Test
	public void testWrongRecipient() throws L2pSecurityException, MalformedXMLException, IOException, MessageException,
	...
	@Test
	public void testReceiverHook() throws L2pSecurityException, MalformedXMLException, IOException, MessageException,
			EncodingFailedException, SerializationException {
		UserAgent eve = MockAgentFactory.getEve();
		eve.unlockPrivateKey("evespass");
	...
	@Test
	public void testHandlersAcceptBeforeDeny() throws MessageException, EncodingFailedException, L2pSecurityException,
	...
	@Test
	public void testHandlersDenyBeforeAccept() throws MessageException, EncodingFailedException, L2pSecurityException,
			SerializationException, MalformedXMLException, IOException {
		UserAgent eve = MockAgentFactory.getEve();
		eve.unlockPrivateKey("evespass");
		Context c = new Context(null, eve);
