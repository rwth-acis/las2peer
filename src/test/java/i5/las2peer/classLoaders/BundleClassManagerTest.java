...
public class BundleClassManagerTest {
	...
	public void testSimpleResourceRetrieval() throws IOException {
		...
		LibraryClassLoader lib1 = new LibraryClassLoader(
				LoadedLibraryCache.createFromJar("export/jars/i5.las2peer.classLoaders.testPackage1-1.1.jar"), testee);
		LibraryClassLoader lib2 = new LibraryClassLoader(
				LoadedLibraryCache.createFromJar("export/jars/i5.las2peer.classLoaders.testPackage2-1.0.jar"), testee);
	...
	public void testSimpleClassLoading1()
		...
		BundleClassManager testee = new BundleClassManager(ClassLoader.getSystemClassLoader());
		LibraryClassLoader lib1 = new LibraryClassLoader(
				LoadedLibraryCache.createFromJar("export/jars/i5.las2peer.classLoaders.testPackage1-1.0.jar"), testee);
		LibraryClassLoader lib2 = new LibraryClassLoader(
				LoadedLibraryCache.createFromJar("export/jars/i5.las2peer.classLoaders.testPackage2-1.0.jar"), testee);
		testee.initLibraryLoaders(new LibraryClassLoader[] { lib1, lib2 });
