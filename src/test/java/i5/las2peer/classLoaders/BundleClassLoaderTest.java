...
public class BundleClassLoaderTest {
	...
	public void testSeperateCounters() throws IOException, ClassNotFoundException, SecurityException,
		...
		{
			LibraryClassLoader lib10 = new LibraryClassLoader(
					"export/jars/i5.las2peer.classLoaders.testPackage1-1.0.jar");
			LibraryClassLoader lib11 = new LibraryClassLoader(
					"export/jars/i5.las2peer.classLoaders.testPackage1-1.1.jar");
			LibraryClassLoader lib2 = new LibraryClassLoader(
					"export/jars/i5.las2peer.classLoaders.testPackage2-1.0.jar");
